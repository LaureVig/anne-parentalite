...
export const PRESTATIONS: Prestation[] = [
    {
        ...
        description: "<p>Chaque enfant est unique et son, ses parents également !</p>"+
        "<p>L'arrivée d'un bébé provoque un bouleversement. Il est souvent difficile de  comprendre ce petit être qui a des rythmes, un sommeil, une communication… différents de l'adulte.</p>"+
        "<p>Il n'y a pas de recette Miracle ! Ensemble, avec un temps d'échange, une écoute attentive, sans jugement ni tabou, je vous propose un accompagnement. "+
    ...
    },
    {
        ...
        prix: 50,
        duree_session: "3h",
        name: "Apprentissage des massages pour bébé (de 1 à 12 mois) en groupe",
        description: "Instructrice en massages pour bébé de l'AFMB (Association Française de Massages pour Bébé),"+
        ...
        " Je vous montre les massages sur un poupon, votre bébé sera touché, massé uniquement par vous.<br>"+
        "Pourquoi masser son bébé ?<br>Il y a quatre grandes catégories de bienfaits pour le bébé : "+
        ...
        "<li>La stimulation du développement de la conscience corporelle, des systèmes circulatoires, hormonaux (ocytocine,..), immunitaire, respiratoire, …</li></ul>"+
        "Pour vous les parents, voici les bienfaits attendus : "+
        ...
        "<li>la rencontre avec d’autres parents...</li></ul>"+
        ...
        "<p>Comment s’organise l’atelier ? </p>"+
